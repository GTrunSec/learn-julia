...
{fetchgit}: {
  ...
  registryRev = "6af762cf4fffb27dd56cbe9118aee8e561fa539b";
  registrySha256 = "0msxy7gyww5hagrrhl62z2qrw013bvv9wgww1k03nc2c77qlagf4";
  rootPackages = ["Distributions" "ForwardDiff" "Optim" "Pluto" "StatsFuns"];
  closure = [{
  name = "ArrayInterface";
