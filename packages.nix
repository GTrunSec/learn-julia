...
{fetchgit}: {
  ...
  registryRev = "27748d73ab5a7f823083ea52d537becb5b3b7a1b";
  registrySha256 = "0nwdc5z02icvr5v3y77k6isjqx7qkkvmc8ksyr6c4z8hnxqhsgzr";
  rootPackages = ["Distributions" "ForwardDiff" "IJulia" "Pluto" "StatsFuns"];
  closure = [{
  name = "Artifacts";
