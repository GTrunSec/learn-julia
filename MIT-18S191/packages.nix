...
{fetchgit}: {
  ...
  registryRev = "248e9b4797617eb54af430fd44404a9ed6e07dc9";
  registrySha256 = "15k9hrblag5d13npb8i2aqlr41b68fishk5n36wvskysk7r0px2h";
  ...
  replaceUrlInManifest = null;
  treehash = "d659e42240c2162300b321f05173cab5cc40a5ba";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaDiff/ChainRulesCore.jl.git"; rev = "d659e42240c2162300b321f05173cab5cc40a5ba"; sha256 = "1cam4ypmribzvkzm2qvg9abj7x89rnsz3a0yfgrjsbzazd9wa36h"; };
} {
  ...
  path = "C/Compat";
  replaceUrlInManifest = null;
  treehash = "e4e2b39db08f967cc1360951f01e8a75ec441cab";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaLang/Compat.jl.git"; rev = "e4e2b39db08f967cc1360951f01e8a75ec441cab"; sha256 = "1qs6fm58dicdjy69qk5p0ndj2b7qsvg7rmydq7igvrvirad55v56"; };
} {
  ...
  path = "H/HTTP";
  replaceUrlInManifest = null;
  treehash = "86ed84701fbfd1142c9786f8e53c595ff5a4def9";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaWeb/HTTP.jl.git"; rev = "86ed84701fbfd1142c9786f8e53c595ff5a4def9"; sha256 = "0xc4hp88packnghvdh8ymb8dw9m5snb5ryx53nvlnvia80494rpb"; };
} {
  name = "IniFile";
  ...
  replaceUrlInManifest = null;
  treehash = "1ba664552f1ef15325e68dc4c05c3ef8c2d5d885";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaStats/LogExpFunctions.jl.git"; rev = "1ba664552f1ef15325e68dc4c05c3ef8c2d5d885"; sha256 = "0rvms3mmq8a1viqlyzdgs2ccddcy6j0c677dlb8m5nk6hkiwr16n"; };
} {
  name = "Logging";
  ...
  path = "S/StaticArrays";
  replaceUrlInManifest = null;
  treehash = "42378d3bab8b4f57aa1ca443821b752850592668";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaArrays/StaticArrays.jl.git"; rev = "42378d3bab8b4f57aa1ca443821b752850592668"; sha256 = "05z5w62v87l0599psyh7v3a4gwrd22rhf8qjzp58qcg5pi9zybi8"; };
} {
  name = "Statistics";
  ...
  path = "T/Tables";
  replaceUrlInManifest = null;
  treehash = "aa30f8bb63f9ff3f8303a06c604c8500a69aa791";
  artifacts = {};
  src = fetchgit { url = "https://github.com/JuliaData/Tables.jl.git"; rev = "aa30f8bb63f9ff3f8303a06c604c8500a69aa791"; sha256 = "0yfjl4v1vglsk9wr7gbqgya4kk3a0q0i6zhi9xdgvnqsqzqrsc7c"; };
} {
  name = "Test";
